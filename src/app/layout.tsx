...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | CRYPTIS Intelligence",
  },
  ...
  openGraph: {
    title: "CRYPTIS — Open Source Intelligence Platform | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "CRYPTIS — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ CRYPTIS — Open Source Intelligence Platform | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "CRYPTIS",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "CRYPTIS — OSINT Toolkit & Intelligence Platform",
  alternateName: ["CRYPTIS", "CRYPTIS Intelligence", "CRYPTIS OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="CRYPTIS Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
